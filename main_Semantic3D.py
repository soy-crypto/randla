...
class Semantic3D:
    def __init__(self):
        ...
        self.label_to_names = {0: 'unlabeled',
                               ...
                               8: 'cars'}
        '''
        self.path = '/data/semantic3d_yu/training'
        self.label_to_names = {0: 'unlabeled',
                               1: 'ground',
                               2: 'vegatation',
                               3: 'building'
        ...
        print("self.train_files: " + str(self.train_files))
        print("self.val_files: " + str(self.val_files))
        print("self.test_files: " + str(self.test_files))
