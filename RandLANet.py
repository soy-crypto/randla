...
class Network:
    def __init__(self, dataset, config):
        ...
        with tf.variable_scope('inputs'):
            ...
            #New_add
            print("self.inputs['xyz'] " + str(self.inputs['xyz']))
            print("self.labels " + str(self.labels.shape))
            print("self.inputs['features'] " + str(self.inputs['features'].shape))
            print("self.inputs['labels'] " + str(self.inputs['labels'].shape))
